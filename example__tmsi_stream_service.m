...
buffer = [ ...
        StreamBuffer(channels.(device(1).tag).n.channels, channels.(device(1).tag).n.samples, device(1).tag), ...
        StreamBuffer(channels.(device(2).tag).n.channels, channels.(device(2).tag).n.samples, device(2).tag) ...
        ];
