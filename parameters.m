...
arguments (Repeating)
    varargin {mustBeMember(varargin, {'config', ...
                                      'liblsl_folder', ...
                                      ...
                                      'raw_data_folder', ...
                                      'preliminary_output_folder', ...
                                      'color_textiles', ...
                                      'default_training_log_file', ...
                                      'default_metadata_file', ...
                                      'local_pat_log_folder', ...
                                      'local_volumes_folder', ...
                                      'local_simulated_3d_surfaces_folder', ...
                                      'max_brain_mesh_folder', ...
                                      'frame_dir', ...
                                      'vid_dir', ...
                                      'monkey_arms_dir', ...
                                      'version', ...
                                      'patch_clim', ...
                                      'simulated_field_clim', ...
                                      'trigger_channel_name', ...
                                      'sync_indicator_bit', ...
                                      'sync_missing_backup_strategy', ...
                                      'pulse_width', ...
                                      'pulse_amplitude', ...
                                      'burst_period', ...
                                      'muscle_name', ...
                                      ...
                                      'min_delay', ...
                                      'max_delay', ...
                                      'exemplar_emg_duration_long', ...
                                      'exemplar_emg_duration_short', ...
                                      'y_scale_emg', ...
                                      'x_scale_emg', ...
                                      'c', ...
                                      'RMS', ...
...
pars.raw_data_folder = 'C:/Data/MetaWB';
...
pars.color_textiles = [...
    cm.umap([166 25 46]./255,32); ... #A6192E
    cm.umap([51 63 72]./255,32); ... #333F48
    cm.umap([240 90 40]./255,32); ... #F05A28
    cm.umap([164 97 164]./255,32);... #A461A4
    cm.umap([255 184 28]./255,32); ... #FFB81C
    cm.umap([0 178 169]./255,32);... #00B2A9
    cm.umap([124 194 66]./255,32); ... #7CC242
    cm.umap([108 172 228]./255,32); ... #6CACE4
    ];
