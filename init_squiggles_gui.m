...
ax = axes(squiggles.fig,'NextPlot','add','FontName','Tahoma', ...
    'XLim',[1, squiggles.n_samples], 'XTick', [], ...
    'XColor','none','YColor','none');
squiggles.h = struct;
squiggles.h.xline = xline(ax, squiggles.n_samples/2, ...
    'k:', seconds_2_str(0.5));
squiggles.h.A = plot(ax, 1:squiggles.n_samples, nan(numel(squiggles.channels.A),squiggles.n_samples));
squiggles.h.B = plot(ax, 1:squiggles.n_samples, nan(numel(squiggles.channels.B),squiggles.n_samples));
