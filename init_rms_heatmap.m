function [hFigure, hImage, hColorBar, hChTxt] = init_rms_heatmap(options)
...
arguments
    ...
    options.CLim (1,2) double {mustBePositive, mustBeInteger} = [1 10];
...
title(ax, sprintf('%s: Block-%02d Forearm Heatmap',options.Subject, options.Block), 'FontName', 'Tahoma', 'Color', 'k');
for ii = 1:nGrids
...
hFigure.UserData.RisingThreshControl = uicontrol(hFigure,'Style','edit',...
    ...
    'Position', [20 300 60 15], ...
    'String', RISING_THRESH, 'FontName', 'Consolas', ...
...
hFigure.UserData.FallingThreshControl = uicontrol(hFigure,'Style','edit',...
    ...
    'Position', [20 230 60 15], ...
    'String', FALLING_THRESH,  'FontName', 'Consolas', ...
